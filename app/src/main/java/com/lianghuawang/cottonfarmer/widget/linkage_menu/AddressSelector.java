...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    ...
    private OnClickDisappearListener onClickDisappearListener;
    ...
    private void init(Context context) {
        ...
        RelativeLayout relativeLayout = (RelativeLayout) inflater.inflate(R.layout.address_title,null);
        addView(relativeLayout);
        ImageView disappear = relativeLayout.findViewById(R.id.disappear);
        disappear.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                onClickDisappearListener.onclick();
            }
        });
     ...
     * 设置列表的点击事件回调接口
     */
    public void setOnItemClickListener(OnItemAddressClickListener onItemClickListener) {
        this.onItemClickListener = onItemClickListener;
    }

    public void setDisapperListener(OnClickDisappearListener onClickDisappearListener){
        this.onClickDisappearListener = onClickDisappearListener;
    }
    /**
     * 设置列表的数据源，设置后立即生效
     */
    public void setCities(ArrayList cities, int activityType, boolean tabIndex, Context context) {
        if (tabIndex){
            //顶部的tab集合
            tabs = null;
            onItemClickListener = null;
            onClickDisappearListener = null;
