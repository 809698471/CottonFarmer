...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        mEtTextSize = typedArray.getDimensionPixelSize(R.styleable.vericationCodeView_vcv_et_text_size, 18);
    ...
    private void initEditText(EditText editText, int i) {
        ...
        ss.setSpan(new StyleSpan(Typeface.BOLD_ITALIC), 0, editText.getText().length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
